// Forked from https://github.com/labstack/echo/blob/98ca08e7dd64075b858e758d6693bf9799340756/middleware/cors.go
...
type CORSConfig struct {
	...
	//
	// Optional.
	AllowOriginFunc func(request *http.Request, origin string) (bool, error) `yaml:"-"`
	...
	return func(next echo.HandlerFunc) echo.HandlerFunc {
		return func(c echo.Context) error {
			...
			if config.AllowOriginFunc != nil {
				allowed, err := config.AllowOriginFunc(c.Request(), origin)
				if err != nil {
					return err
				}
				if allowed {
